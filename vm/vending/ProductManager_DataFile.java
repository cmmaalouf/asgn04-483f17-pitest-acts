...
public class ProductManager_DataFile implements IProductManager {
	...
	//I'm warning about an IOException because I am unfamiliar with Java.
	//I want to explicitly throw a FileNotFoundException if it doesn't exists, but I don't know if I handled
	//every IO exception (e.g. file currently in use, permissions, etc).
	/**
